...
print("🏞️ TARGET: PHASE 1 LAKES ONLY (11 Locations)")
...
print(f"✅ Training on {len(df)} pristine Lake observations...")
...
print("-" * 55)
print(f"{'🏆 LAKES ENSEMBLE':<30} | {r2_ens:>8.4f} | {rmse_ens:>8.4f}")
print("=========================================================\n")